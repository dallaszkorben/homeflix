...
''', {'user_id': 1234, 'history_back': 0, 'view_state': None, 'tag': 'Masterpiece', 'level': None, 'category': 'movie', 'genre': None, 'theme': None, 'origin': 'us', 'director': None, 'actor': None, 'lecturer': None, 'decade': None, 'lang': 'en'})
for rec in res.fetchall():
    print(rec)

{'user_id': 1234, 'history_back': 0, 'view_state': 'interrupted', 'tag': 'Masterpiece', 'level': None, 'category': 'movie', 'genre': None, 'theme': None, 'origin': 'us', 'director': None, 'actor': None, 'lecturer': None, 'decade': None, 'lang': 'en'})
...
curl -b cookies_1.txt --header "Content-Type: application/json" --request GET  http://localhost:80/collect/lowest/category/movie/view_state/interrupted/tags/*/level/*/genres/*/themes/*/directors/*/actors/*/lecturers/*/origins/*/decade/*/lang/en
...
# fetch lowest level
curl -b cookies_1.txt --header "Content-Type: application/json" --request GET  http://localhost:80/collect/lowest/category/movie/view_state/*/tags/*/level/*/genres/*/themes/*/directors/*/actors/*/lecturers/*/origins/*/decade/*/lang/en
