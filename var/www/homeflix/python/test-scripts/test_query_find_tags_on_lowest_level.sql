...
SELECT *
            ...
            WHERE
                CASE
                    WHEN :view_state = 'interrupted' THEN
                        start_epoch >= :history_back
                        AND recent_position < net_stop_time
                        AND recent_position > net_start_time
            ...
            ORDER BY raw_query.start_epoch DESC
            LIMIT :limit;
            ''', {'user_id': 1234, 'category': 'movie', 'level': None, 'view_state': 'interrupted', 'history_back': 1698512575, 'decade': None, 'lang': 'hu', 'limit': 100}).fetchall()
...
# fetch tags
curl -b cookies_1.txt --header "Content-Type: application/json" --data '{"category":"movie"}' --request GET http://localhost:80/personal/tag/get
curl -b cookies_1.txt --header "Content-Type: application/json" --request GET http://localhost:80/personal/tag/get/category/movie/genres/*/themes/*/directors/*/actors/*/lecturers/*/origins/*/decade/*/lang/en
