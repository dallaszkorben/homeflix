...
class MainMenuContainerGenerator extends ContainerGenerator{  
    getContainerList(){
        ...
        thumbnail.setFunctionForSelection({"menu":
            (function(){
                return function(){
                    return new KnowledgeMenuContainerGenerator(refToThis.language_code, translated_titles['knowledge']);
                }
            })()});
...
// ==============
//
class KnowledgeMenuContainerGenerator extends AjaxContainerGenerator{
    constructor(language_code, container_title){
        super(language_code);
        this.container_title = container_title;
    }
...
//        thumbnail.setExtras(length=card["length"], date=card["date"], origins=card["origins"], genres=card["genres"], themes=card["themes"]);
        ...
        thumbnail.setFunctionForSelection({"menu": 
            (function(hierarchy_id) {
                return function() {
                    return new KnowledgeSubMenuContainerGenerator(refToThis.language_code, short_title, hierarchy_id);
                };
            })(hit["id"])
        });
        return thumbnail;
...
class KnowledgeSubMenuContainerGenerator extends  AjaxContainerGenerator{
    constructor(language_code, container_title, hierarchy_id){
        super(language_code);
        this.container_title = container_title;
        this.hierarchy_id = hierarchy_id;
...
class MusicVideoContainerGenerator extends  AjaxContainerGenerator{
    ...
    getContainerList(){
         ...
         let requestList = [
             {title: "70s",  rq_method: "GET", rq_url: "http://" + host + "/collect/general/level/band/category/music_video/genre/*/theme/*/origin/*/not_origin/*/decade/70s/lang/" +  this.language_code},
             {title: "80s",  rq_method: "GET", rq_url: "http://" + host + "/collect/general/level/band/category/music_video/genre/*/theme/*/origin/*/not_origin/*/decade/80s/lang/" +  this.language_code},
             {title: "90s",  rq_method: "GET", rq_url: "http://" + host + "/collect/general/level/band/category/music_video/genre/*/theme/*/origin/*/not_origin/*/decade/90s/lang/" +  this.language_code},
             {title: "2000s",  rq_method: "GET", rq_url: "http://" + host + "/collect/general/level/band/category/music_video/genre/*/theme/*/origin/*/not_origin/*/decade/2000s/lang/" +  this.language_code},
             {title: "2010s",  rq_method: "GET", rq_url: "http://" + host + "/collect/general/level/band/category/music_video/genre/*/theme/*/origin/*/not_origin/*/decade/2010s/lang/" +  this.language_code},
         ];
...
//        thumbnail.setExtras(length=card["length"], date=card["date"], origins=card["origins"], genres=card["genres"], themes=card["themes"]);
            ...
            let card_id = hit["id"];
            let card_request_url = "http://" + host + "/collect/standalone/music_video/card_id/" + card_id + "/lang/" + this.language_code
            let card = this.sendRestRequest("GET", card_request_url)[0];
...
//            thumbnail.setExtras(date=hit["date"], origins=hit["origins"], genres=hit["genres"]);
            ...
            let card_id = hit["id"];
            let card_request_url = "http://" + host + "/collect/standalone/music_audio/card_id/" + card_id + "/lang/" + this.language_code
