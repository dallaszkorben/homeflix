...
# ---
    ...
    def gggget_lowest_level_cards(self, category, playlist=None, tags=None, level=None, genres=None, themes=None, directors=None, actors=None, lecturers=None, origins=None, decade=None, lang='en', limit=100, json=True):
        """
        FULL QUERY for lowest (medium) level list
        Returns only medium level cards level cards
        With filters category/genre/theme/origin/director/actor 
